        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="card-header">
                        <h4 class="card-title"> HSC Details </h4>
                    </div>  
                    <table class="table table-striped table-hover  " >
                        <tbody >
                        <?php
                            include "config.php";      
                            $conn = mysqli_connect($host,$user,$pass,$db);
                            $query = "Select * from hsc_details where gr_no = '$gr_no'";
                            $result = mysqli_query($conn,$query);
                            while($data = mysqli_fetch_array($result))
                            {
                            ?>
                    ...
                    <table class="table table-striped table-hover  " >
                        ...
                        <?php
                            include "config.php";      
                            $conn = mysqli_connect($host,$user,$pass,$db);
                            $query = "Select * from contact_details where gr_no = '$gr_no'";
                            $result = mysqli_query($conn,$query);
                            while($data = mysqli_fetch_array($result))
                            {
                            ?>
                    ...
                    <table class="table table-striped table-hover  " >
                        ...
                        <?php
                            include "config.php";      
                            $conn = mysqli_connect($host,$user,$pass,$db);
                            $query = "Select * from guardian_details where gr_no = '$gr_no'";
                            $result = mysqli_query($conn,$query);

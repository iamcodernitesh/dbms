                                ...
                                <div class="row">
                                    <div class="col-md-6 pr-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  placeholder="GR Number" value="21910">
                                        </div>
                                    </div>
                                    <div class="col-md-6 pl-1">
                                        <div class="form-group">
                                            <label>Attendance In Percentage(%)</label>
                                            <input type="text" class="form-control"  placeholder="Insert Attendance in Percentage" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <button class="btn btn-success btn-block" onclick="demo.showNotification('bottom','left')">Insert</button>
                                </div>
                            </div>
                        </div>
                    </div>
